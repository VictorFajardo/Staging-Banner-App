window.onload = function() {
  ...
  TweenLite.to(sheet1, .75, {y: 970, rotation: -87, rotationX: -10, rotationY: 10, scale: 1.2, ease: Power2.easeOut, delay: 4.6}, 0);
  ...
  TweenLite.to(sheet2, .75, {y: 970, rotation: -24, rotationX: -10, rotationY: 10, scale: 1.2, ease: Power2.easeOut, delay: 9.2}, 0);
  ...
  TweenLite.to(sheet3, .75, {y: 970, rotation: -15, rotationX: -10, rotationY: 10, scale: 1.2, ease: Power2.easeOut, delay: 13.25}, 0);


  TweenLite.to(text3, .1, {height: 0, ease: Power0.easeNone, delay: 13.3}, 0);
  TweenLite.to(text4, .15, {height: 60, ease: Power0.easeNone, delay: 13.25}, 0);
