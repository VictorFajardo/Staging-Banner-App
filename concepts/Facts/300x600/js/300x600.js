window.onload = function() {
  ...
  gsap.to(sheet1, .75, {y: 970, rotation: -187, rotationX: -10, rotationY: 10, scale: 1.2, ease: Power2.easeOut, delay: 4.6}, 0);
  gsap.to(text1, .1, {height: 0, ease: Power0.easeNone, delay: 4.58}, 0);
  gsap.to(text2, .1, {height: 150, ease: Power0.easeNone, delay: 4.58}, 0);
  gsap.to(sheet2, .75, {y: 970, rotation: -124, rotationX: -10, rotationY: 10, scale: 1.2, ease: Power2.easeOut, delay: 9.2}, 0);
  gsap.to(text2, .1, {height: 0, ease: Power0.easeNone, delay: 9.18}, 0);
  gsap.to(text3, .1, {height: 120, ease: Power0.easeNone, delay: 9.18}, 0);
  gsap.to(sheet3, .75, {y: 970, rotation: -115, rotationX: -10, rotationY: 10, scale: 1.2, ease: Power2.easeOut, delay: 13.25}, 0);
  gsap.to(text3, .1, {height: 0, ease: Power0.easeNone, delay: 13.3}, 0);
  gsap.to(text4, .15, {height: 30, ease: Power0.easeNone, delay: 13.25}, 0);
