window.onload = function() {
  ...
  gsap.to(sheet1, .75, {x: -360, rotation: -37, rotationX: -10, rotationY: 10, scale: 1.2, ease: Power2.easeOut, delay: 4.6}, 0);
  gsap.to(text1, .1, {width: 0, ease: Power0.easeNone, delay: 4.68}, 0);
  gsap.to(text2, .1, {width: 120, ease: Power0.easeNone, delay: 4.68}, 0);
  gsap.set(text2, {rotation: 0, x: -120, y: -150, delay: 4.8}, 0);
  gsap.set(text2inner, {rotation: 0, delay: 4.8}, 0);
  gsap.to(sheet2, .75, {x: -360, rotation: -24, rotationX: -10, rotationY: 10, scale: 1.2, ease: Power2.easeOut, delay: 9.2}, 0);
  gsap.to(text2, .1, {width: 0, ease: Power0.easeNone, delay: 9.28}, 0);
  gsap.to(text3, .1, {width: 150, ease: Power0.easeNone, delay: 9.28}, 0);
  gsap.set(text3, {rotation: 0, x: -150, y: -90, delay: 9.4}, 0);
  gsap.set(text3inner, {rotation: 0, delay: 9.4}, 0);
  gsap.to(sheet3, .75, {x: -360, rotation: -15, rotationX: -10, rotationY: 10, scale: 1.2, ease: Power2.easeOut, delay: 13.25}, 0);
  gsap.to(text3, .1, {width: 0, ease: Power0.easeNone, delay: 13.3}, 0);
  gsap.to(text4, .15, {width: 220, ease: Power0.easeNone, delay: 13.25}, 0);
